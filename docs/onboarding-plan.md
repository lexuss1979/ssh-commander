...
> **Статус: реализован.** Фиксы ревью — эпик 21 в `docs/settings-model-plan.md`;
> дальнейшее развитие модели настроек — там же (эпики 21–24). Цель — убрать обязательность `.env`
